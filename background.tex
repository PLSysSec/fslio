...
%
The immutable label makes the semantics straight forward: writing a term to a
...
flow-insensitive and flow-sensitive productions, the semantics for latter are
...
flow-sensitive (|S|) reference are given in Figure~\ref{fig:fs-exts-semantics}.
\label{fig:sos:refs}}
\end{figure}
