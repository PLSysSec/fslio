\begin{abstract}
  ...
  several reasons: it often boosts permissiveness and reduces the burden of
  ...
  %
  We present an extension for LIO---a language-based floating-label
  ...
  reference, we additionally provide a mechanism for automatic upgrades.
  %
