...
changes, a policy known as \emph{no-sensitive
  upgrades}~\Red{\cite{Zdancewic02programminglanguages}}% \cite{Austin:Flanagan:PLAS10}
...
discipline~\Red{\cite{Zdancewic02programminglanguages}}).%Austin:Flanagan:PLAS10})
