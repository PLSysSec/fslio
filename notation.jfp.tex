...
%format forkLIO'
%format withRefs = "\textbf{withRefs}"
%format waitLIO = "\textbf{waitLIO}"
%format upgradeM = "\textbf{upgradeStore}"
...
\newcommand{\lioconc}{\ensuremath{\lambda^{\textsf{\tiny LIO}}_{|lattice|,\parallel}}}
