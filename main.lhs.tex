...
\IEEEauthorblockA{Chalmers \\ 
    russo@@chalmers.se}
\and
\IEEEauthorblockN{David Mazi{\`e}res}
\IEEEauthorblockA{Stanford} 
}
...
We thank Stefan Heule and Edward Z. Yang for their helpful comments on
an earlier draft.  This work was funded by the Swedish research agency
VR.  Deian Stefan is supported by the DoD through the NDSEG Fellowship
Program.
