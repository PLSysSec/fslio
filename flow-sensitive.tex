...
{ |c = (lcurr, mI, mS)|\\
  |lcurr canFlowTo l|\\
  |c' = c [ m_alpha mapsto m_alpha[a mapsto (lcurr, LabeledTCB l t)] ]|
}
{ |conf c (E[newRef alpha l t]) --> conf c' (E[return (LIORefTCB alpha a)])| }
{ |fresh a| }
...
\inferrule[readRef]
{ |c = (lcurr, mI, mS)| \\
  |(lf, LabeledTCB l v) = m_alpha(a) | }
{ |conf c (E[readRef alpha (LIORefTCB alpha a)]) --> conf c (E[unlabel (LabeledTCB (lf lub l) v)])| }

% \and
% \inferrule[readRef-I]
% { |c = (lcurr, m)| \\ |(lf, v) = m(a)| }
% { |conf c (E[readRef I (LIORefTCB I a)]) --> conf c (E[unlabel v])| }
...
{ |c = (lcurr, mI mS)|\\
  ...
  |lcurr canFlowTo l|\\
  |c' = c [ m_alpha mapsto m_alpha[a mapsto (lf,LabeledTCB l t)] ]|
}
{ |conf c (E[writeRef alpha (LIORefTCB alpha a) t]) --> conf c' (E[return ()])| }
...
\inferrule[labelOf]
{ |c = (lcurr, mI, mS)|\\
  |(lf, LabeledTCB l t) = m_alpha (a)|
}
{ |conf c (E[labelOfR alpha (LIORefTCB alpha a) t]) --> conf c (E[unlabel (LabeledTCB lf l)])|}
...
{ |c = (lcurr, mI, mS)|\\
%  |lcurr canFlowTo labelOf mS(a) ~>* true|\\
  |(lf, v) = m_FS (a)| \\
  |lcurr lub lf ~>* lcurr'| \\
  |conf c (upgrade v (lf lub lcurr)) ==> conf c (LIOTCB v')|\\
  |c' = c [ m_FS mapsto m_FS [ a mapsto (lf,v') ] ]|
}
