...
{ |conf () (E[newRef S l t]) --> conf c' (E[return (LIORefTCB S a)])| }
{ |fresh a| }
...
\inferrule[upgrade]
{ |c = (lcurr, mI, mS)|\\
  |c' = (lcurr, mI, upgradeM mS l {a})|
}
{ |conf c (E[upgrade (LIORefTCB S a) l]) --> conf c' (E[return ()])| }
...
{|c = (lcurr, mI, mS)|\\
 |lcurr canFlowTo l|\\
 |mS' = {a mapsto mS(a) divisor a element dom mS and addrs(v) }|\\
