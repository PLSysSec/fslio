...
% label checks.
\begin{definition}[Reference-implementation abstraction]
|LIORefTCB S t| $\cong$ |LIORefTCB S t'|, otherwise
|t| $\cong$ |t'| if |t = t'|
\end{definition}

\begin{theorem}[Kleene equivalence]
Forall |t,v| in \lio{}, and 
|t', v'| in \liofs{}, such that |v| $\cong$ |v'|,
|t| $\cong_\textrm{kleene}$ |t'| iff
|conf c t  ==> diverge| $\Leftrightarrow$ |conf c t' ==> diverge| and 
|conf c t  ==> v| $\Leftrightarrow$ |conf c t' ==> v'|.
\end{theorem}
