...
\and
\inferrule{l \flows \env.\lbl \and \RTS' = \RTS[ x \mapsto \Lb{\env.\lbl}{\bot}{v} ]}
...
{\defRTS{E[\writeRefFSI{(\LIORefRTS{l}{x})}{v}]} \lto \wEnvRTS{\env}{\RTS}{E[\returnLIO{()}]}}[\textsc{WriteRef-FSI}]
\and
\inferrule{\env.\lbl\flows l \and l\flows l' \and \Lb{l}{u}{v} = \RTS(x) \and \RTS'=\RTS[x\mapsto\Lb{l'}{\top}{v}]}
{\defRTS{E[\upgrade{(\LIORef{l}{x})}{l'}]} \lto \wEnvRTS{\env}{\RTS'}{E[\returnLIO{()}]}}[\textsc{Upgrade}]
\and
\inferrule{}
...
\small
\begin{mathpar}
\inferrule{\env.\lbl \flows l \flows \env.\clr \\ \defRTS{t}\lto^*\wEnvRTS{\env'}{\RTS'}{\lioValp{t'}} \\ \env'' = \env[\lbl\mapsto\env.\lbl \lub \env'.\fel, \fel\mapsto\env'.\fel]}
{\defRTS{E[\toLabeled{l}{t}]} \lto \\ \wEnvRTS{\env''}{\RTS'}{E[\returnLIO{(\Lb{l}{\bot}{t'})}]}}[\textsc{toLabeled}]
\end{mathpar}
