...
Figure~\ref{fig:fs-attack}. \Red{The function |when| acts like an |if|
  statement without the |else| branch, and |($)| is an alternative
...
popular no-sensitive upgrades, \Red{first proposed by Zdancewic~\cite{Zdancewic02programminglanguages} and named by Austin and Flanagan~\cite{Austin:Flanagan:PLAS09}}.
%
%\hl{Ale: to do}
