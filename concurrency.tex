...
concurrrency.
%
Concretely, we consider a subset of the concurrent version of
LIO~\tocite{ifcp}, to extend our sequential \liofs{} and \lioafs{} calcului
with threads and a new terminal, |forkLIO|, for dynamically creating new
threads.
%
Intuitively, our concurrent calculus simply defines scheduler over sequential
threads; taking a step in the concurrent calculus amounts to taking a step in a
sequential thread and context switching to a different thread.
%
For brevity, we restrict our discussion in this section to the case where the
underlying calculus is \lioafs{}, which is itself an extension of \liofs.
