...
in the concurrent version of LIO~\tocite{stefan:addressing-covert}.
%
...
from the underlying sequential calculus, as in~\tocite{ifcp}.\footnote{ As
discussed in~\tocite{stefan:addressing-covert}, |forkLIO| with synchronization
primitives can be used to provide functionality equivalent to that of
|toLabeled|, especially addressing the label creep problem discussed in
